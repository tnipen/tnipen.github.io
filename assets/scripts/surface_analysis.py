...
#mpl.show()
mpl.savefig("../img/titan_sct.png", bbox_inches='tight', dpi=125)
mpl.clf()
...
#mpl.show()
mpl.savefig("../img/analysis_increment.png", bbox_inches='tight', dpi=125)
mpl.clf()
...
cb.set_label(r"Increment ($\degree C$)")
#mpl.show()
mpl.savefig("../img/analysis_increment_ens.png", bbox_inches='tight', dpi=125)
